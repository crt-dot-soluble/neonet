...
/// </summary>
internal class TextureTest : GameEngine
{
    private readonly float[] _vertices =
    {
        // Vertex Positions (X, Y, Z)       // Texture Coordinates
         0.5f,   0.5f,   0.0f,              1.0f, 1.0f,   // TOP RIGHT
         0.5f,  -0.5f,   0.0f,              1.0f, 0.0f,   // BOTTOM RIGHT      - SHARED
        -0.5f,  -0.5f,   0.0f,              0.0f, 0.0f,   // BOTTOM LEFT
        -0.5f,   0.5f,   0.0f,              0.0f, 1.0f,   // TOP LEFT          - SHARED
    };
    ...
    public TextureTest(string title, int width, int height) : base(title, width, height)
    {
    }
    ...
    {
        var shaderSourceCode = Shader.Parse("./res/shaders/Texture.glsl");
        ...
        _texture2d = ResourceManager.Instance.LoadTexture("./res/textures/unknown.png");
        _texture2d.Use();
